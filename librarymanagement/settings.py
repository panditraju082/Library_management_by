...
DATABASES = {
    'default': {
        ...
        'NAME': 'library_system',#your database name
        'USER': 'root',#your data base user name
        'PASSWORD': '',#Your database passwprd
        'HOST': 'localhost',#your loacalhost name
        'PORT': '3306',#your mysql serrver
    }
}
